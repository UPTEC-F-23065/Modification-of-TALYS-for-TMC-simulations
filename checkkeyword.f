...
c Added one keyword: geffissionfileid and increased numkey to 397 (from 396)
c		     (new keyword placed in last position in list of keywords)
c *************************************************************************
c
...
c
     ...
     +  'block', 'branch', 
     +  'breakupmodel', 'cbreak', 'cfermi', 'cglobal', 
     ...
     +  'xsptherm', 'yieldfile', 'yieldunit','geffissionfileid'/
c
